...
![](https://cdn-images-1.medium.com/max/1600/1*OCKAB543seR8CUgTT1Cz1g.png)
<span class="figcaption_hack">Extended Data Figure 6 from the [1000 Genomes
...
low allele frequency hence the relatively young age of the associated mutations.</span>
...
![](https://cdn-images-1.medium.com/max/1200/1*X9TYud_YiRwd4Y-p9Xdi9w.png)
<span class="figcaption_hack">A schematic illustrating the rare allele coalescent, taken from Figure 3 of [our
paper on Anglo-Saxon history](https://www.nature.com/articles/ncomms10408).</span>
...
![](https://cdn-images-1.medium.com/max/1600/1*UlbERyNiH2DqtPmPw8UOqw.png)
<span class="figcaption_hack">A simulated population history (left), and the inferred model from rarecoal*
*using rare mutations up to allele count 4. Details can be found in [Schiffels
et al. 2016](https://www.nature.com/articles/ncomms10408)</span>
...
![](https://cdn-images-1.medium.com/max/1200/1*g1oBiMU3nidCOOdfFRWMoA.png)
